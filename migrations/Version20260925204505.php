 ...
 */
final class Version20260925204505 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE note DROP matiere');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE note ADD matiere VARCHAR(255) NOT NULL');
