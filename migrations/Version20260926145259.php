 ...
 */
final class Version20260926145259 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evaluation DROP matiere');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evaluation DROP CONSTRAINT FK_1323A575F46CD258');
        $this->addSql('DROP INDEX IDX_1323A575F46CD258');
        $this->addSql('ALTER TABLE evaluation ADD matiere VARCHAR(255) NOT NULL');
